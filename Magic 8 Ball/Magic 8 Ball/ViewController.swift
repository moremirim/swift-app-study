...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var randomBallImageView: UIImageView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        randomBallImageView.image = UIImage(imageLiteralResourceName: "ball1")
    }
   
    @IBAction func askButtonPressed(_ sender: Any) {
        randomBallImageView.image = ballArray.randomElement()
    }
}
